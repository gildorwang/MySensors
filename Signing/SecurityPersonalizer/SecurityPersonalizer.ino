...
// Gildor 4/13/2017
// The sketch is configured to write HMAC key and AES key, and also generate serial number
// Steps:
// 1. Fetch HMAC key and AES key from the Secect Vault, and replace the ones with <KEY HERE>
// 2. Upload the sketch to Arduino board
// 3. Open Serial Monitor, the serial number and both keys will be displayed
// 4. Save the serial number and upload another sketch. Do not reboot the board otherwise the
//    serial number will be re-generated.
...
#define MY_SOFT_HMAC_KEY <KEY HERE>
